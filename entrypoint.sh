...
if [[ $INPUT_PDF_BUILD == true ]]; then 
    ...
    echo $MSG
    asciidoctor-pdf "$INPUT_EBOOK_MAIN_ADOC_FILE" -o "$PDF_FILE" $GENERAL_ASCIIDOCTOR_PARAMS $INPUT_ASCIIDOCTOR_PARAMS
fi
